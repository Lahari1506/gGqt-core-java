...
public class tryandcatch1 {
	public static void main(String[] args) {
		...
		//specific catch
			...
			System.out.println("InputMismatchException generated and handled .");
		}
		catch (ArrayIndexOutOfBoundsException aie ) {
			System.out.println("Exception Occured and handled in catch block.");
		}
		catch(NegativeArraySizeException ne) {
			System.out.println("negative array size exception generated and handled .");
		}
		catch(ArithmeticException ae) {
			System.out.println("Arithematic exception generated and handled .");
		}
		//generic catch
		catch (Exception e) {
			System.out.println("Exception Occured and handled in catch block.");
